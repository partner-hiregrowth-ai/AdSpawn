...
export const VALID_OPTIMIZATION_GOALS: Record<string, string[]> = {
  ...
  OUTCOME_ENGAGEMENT:    ['POST_ENGAGEMENT', 'VIDEO_VIEWS', 'THRUPLAY', 'MESSAGES', 'REACH', 'IMPRESSIONS', 'PAGE_LIKES', 'EVENT_RESPONSES'],
...
export const OPTIMIZATION_GOAL_LABELS: Record<string, string> = {
  ...
  PAGE_LIKES: 'Page Likes', EVENT_RESPONSES: 'Event Responses',
};
