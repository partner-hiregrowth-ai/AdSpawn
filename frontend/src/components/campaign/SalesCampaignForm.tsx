...
export function SalesCampaignForm({ initialValues, onChange }: SalesCampaignFormProps) {
  const [name, setName] = useState<string>(initialValues.name ?? "New Sales Campaign");
  ...
  useEffect(() => {
    ...
    setName(initialValues.name ?? "New Sales Campaign");
  ...
  return (
    <div className="space-y-4">
        ...
        <SectionBody className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <FieldRow label="Campaign objective">
              <StaticField value="Sales" />
            </FieldRow>
          </div>
        </SectionBody>
      </SectionCard>

      {/* ── Section 1b: Advantage+ Catalog Ads ── */}
      <SectionCard>
        <div className="flex items-center justify-between gap-4 px-5 py-4 border-b border-gray-800/40">
          <div className="space-y-0.5">
            <h3 className="text-sm font-semibold text-gray-100">Advantage+ catalog ads <span className="text-blue-400">+</span></h3>
          </div>
        ...
        <SectionBody>
          <div className="space-y-3">
            <div className="flex gap-3 p-3.5 rounded-lg bg-blue-500/5 border border-l-2 border-blue-500/20 border-l-blue-500/60">
              ...
              <div className="text-xs text-blue-200/80 space-y-2 flex-1">
                <p className="font-semibold text-blue-300">Turn ads into a shopping experience</p>
          ...
          <SectionBody>
            ...
            <FieldRow label="Campaign bid strategy">
              ...
              >
                <SelectTrigger className="bg-gray-800/30 border-gray-700/40 text-sm text-gray-200 focus:border-blue-500/50">
                  <span className="truncate">
                    {BID_STRATEGIES.find((s) => s.value === bidStrategy)?.label ?? bidStrategy}
                  </span>
                </SelectTrigger>
                <SelectContent className="bg-gray-900 border-gray-800">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <FieldRow label="Increase type">
                      ...
                      >
                        <SelectTrigger className="bg-gray-800/30 border-gray-700/40 text-sm text-gray-200 focus:border-blue-500/50">
                          <span className="truncate">
                            {INCREASE_TYPES.find((t) => t.value === increaseType)?.label ?? increaseType}
                          </span>
                        </SelectTrigger>
                        <SelectContent className="bg-gray-900 border-gray-800">
      ...
      {/* ── Section 3b: Audience Segment Reporting ── */}
      <SectionCard>
        <SectionHeader title="Audience segment reporting" />
        <SectionBody>
          <p className="text-xs text-gray-400 leading-relaxed">
            Define your ad account&apos;s{" "}
            <button type="button" className="text-blue-400 hover:text-blue-300 transition-colors">audience segments</button>
            {" "}in Advertiser settings to receive reporting breakdowns between your new audience, engaged audience and existing customers.{" "}
            <button type="button" className="text-blue-400 hover:text-blue-300 transition-colors">About audience segment reporting</button>
          </p>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1 p-3 rounded-lg bg-gray-800/20 border border-gray-800/40">
              <div className="text-[11px] font-medium text-gray-400">Engaged audience</div>
              <div className="text-xs text-gray-600">Not defined</div>
            </div>
            <div className="space-y-1 p-3 rounded-lg bg-gray-800/20 border border-gray-800/40">
              <div className="text-[11px] font-medium text-gray-400">Existing customers</div>
              <div className="text-xs text-gray-600">Not defined</div>
            </div>
          </div>
        </SectionBody>
