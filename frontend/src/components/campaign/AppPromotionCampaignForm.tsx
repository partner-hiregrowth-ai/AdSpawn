...
interface AppPromotionCampaignFormProps {
  initialValues: Record<string, any>;
  onChange: (values: Record<string, any>) => void;
}

export function AppPromotionCampaignForm({ initialValues, onChange }: AppPromotionCampaignFormProps) {
  // ── Local state derived from initialValues ──
  const [name, setName] = useState<string>(initialValues.name ?? "New App Promotion Campaign");
  ...
  useEffect(() => {
    ...
    setName(initialValues.name ?? "New App Promotion Campaign");
        ...
        <SectionBody className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <FieldRow label="Campaign objective">
              <StaticField value="App Promotion" />
            </FieldRow>
          </div>
        </SectionBody>
      </SectionCard>
