...
interface LeadsCampaignFormProps {
  initialValues: Record<string, any>;
  onChange: (values: Record<string, any>) => void;
}

export function LeadsCampaignForm({ initialValues, onChange }: LeadsCampaignFormProps) {
  // ── Local state derived from initialValues ──
  const [name, setName] = useState<string>(initialValues.name ?? "New Leads Campaign");
  ...
  useEffect(() => {
    ...
    setName(initialValues.name ?? "New Leads Campaign");
